...
class CentralServiceTest(designate.tests.functional.TestCase):
    ...
    def test_create_superzone_failure(self):
        ...
        # The cross-tenant superzone conflict is now caught by
        # _check_zone_ownership_conflicts (CVE-2026-71193), which raises
        # the more specific IllegalParentZone (a subclass of Forbidden).
    ...
    def test_create_zone_duplicate_different_pools_different_tenant_fails(
        ...
        # Attacker is an ordinary tenant '2' (no cross-tenant policy
        # grants), proving the cross-pool bypass is closed by default.
        context = self.get_context()
        context.project_id = '2'
