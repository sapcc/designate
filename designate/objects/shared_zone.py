...
class SharedZone(base.DictObjectMixin, base.PersistentObjectMixin,
    ...
    fields = {
        ...
        'tenant_id': fields.StringFields(maxLength=36, nullable=False),
        'target_tenant_id': fields.StringFields(maxLength=36, nullable=False),
    }

    STRING_KEYS = [
        'id', 'zone_id', 'tenant_id', 'target_tenant_id'
    ]
